...
{% block content %}
    <p class="login-box-msg" style="font-size: 28px; font-weight: bold;">Welcome to Halim's Clinic</p>
    <form action="{{ app_path }}" method="post">
        ...
        <div class="row">
            <div class="col-12">
               <button type="submit" style="background-color: #18D5B9; border:none;" class="btn {{ jazzmin_ui.button_classes.primary }} btn-block">
                    {% trans "Log in" %}
                </button>
            </div>
        </div>
